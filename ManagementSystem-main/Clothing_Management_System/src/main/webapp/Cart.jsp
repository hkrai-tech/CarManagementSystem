...
<!-- header end -->
	...
	<!-- component -->
<div class="text-gray-900 bg-gray-900">
    <div class="p-4 flex">
                ...
                <tr class="border-b hover:bg-orange-100 bg-gray-100">
                    ...
                    <td class="p-3 px-5"><input type="text" value="<%=d.getColor()%>" name='color'" class="bg-transparent"></td>
                      <td class="p-3 px-5"><input type="text" value="<%=d.getPrice()%>" name='price'" class="bg-transparent"></td>
                     	   ...
                     	   <td class="p-3 px-5 flex justify-end"><button type="button" class="text-sm bg-red-500 hover:bg-red-700 text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline"><a href="DeleteCartItem?ItemName=<%=d.getBrand()%>&AgentName=<%=d.getAgent()%>&CategoryName=<%=d.getCategory()%>&PurchaseId=<%=d.getPurchaseId()%>">Delete</a></button></td>
