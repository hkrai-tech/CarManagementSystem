	...
	for(IndividualItem d : arr){ %>
                ...
                <tr class="border-b hover:bg-orange-100 bg-gray-100">
                    ...
                    <td class="p-3 px-5 flex justify-end">  
  					<input type="date" id="birthday" name="RentTime">
					<button type="submit" class="mr-3 text-sm bg-blue-500 hover:bg-blue-700 text-white py-1 px-2 rounded focus:outline-none focus:shadow-outline">Purchase</button></td>
                	<%}
                      else{%>
